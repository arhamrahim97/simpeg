...
class ProsesUsulanKenaikanPangkatKasubag extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.kasubag.kenaikanPangkat.index');
    }
    ...
    public function show(UsulanPangkat $usulanPangkat)
    {
        ...
        return view('pages.kasubag.kenaikanPangkat.show', compact('usulanPangkat', 'berkasDasar', 'user', 'listPangkat'));
    }
    ...
    {
        if (!($usulanPangkat->status_sekretaris == 0 && $usulanPangkat->status_kasubag != 0 && $usulanPangkat->status_kepegawaian == 1)) {
            return redirect()->route('proses-usulan-kenaikan-pangkat-kasubag.index');
        }
        $berkasDasar = BerkasDasar::where('id_user', $usulanPangkat->id_user)->get();
        $user = User::find($usulanPangkat->id_user);
        ...
        return view('pages.kasubag.kenaikanPangkat.edit', compact('usulanPangkat', 'berkasDasar', 'user', 'listPangkat'));
    }
    ...
    {
        $usulanPangkat->status_kasubag = $request->konfirmasi_berkas;
        if ($request->has('usulan_pangkat')) {
            $usulanPangkat->pangkat_selanjutnya = $request->usulan_pangkat;
        }
        $usulanPangkat->tanggal_konfirmasi_kasubag = now();
        if ($request->konfirmasi_berkas == 2) {
            $usulanPangkat->alasan_tolak_kasubag = $request->alasan_ditolak;
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12">
                                                <div class="single-timeline-content d-flex wow fadeInLeft"
                                                    ...
                                                    <div class="timeline-text">
                                                        ...
                                                        <p>Berkas Masih Diproses</p>
                                                        <div class="row">
                                                        <a href=" ' . route('proses-usulan-kenaikan-pangkat-kasubag.show', $usulanPangkat->id) . '" class="btn btn-sm btn-primary mt-2 ml-3">Lihat Berkas</a>
                                                        ' . $btnProses . '
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12">
                                                <div class="single-timeline-content d-flex wow fadeInLeft"
                                                    ...
                                                    <div class="timeline-text">
                                                        <h6>Kasubag Kepegawaian</h6>
                                                        <p>Menyetujui Berkas</p>
                                                        <a href=" ' . route('proses-usulan-kenaikan-pangkat-kasubag.show', $usulanPangkat->id) . '" class="btn btn-sm btn-primary mt-2">Lihat Berkas</a>
                                                        ' . $btnUbah . '
                                                    </div>
                                                </div>
                                            </div>
    ...
    {
        if (!($usulanPangkat->status_kasubag == 0 && $usulanPangkat->status_tim_penilai == 1 && $usulanPangkat->status_kepegawaian == 1)) {
            return redirect()->route('proses-usulan-kenaikan-pangkat-kasubag.index');
        }
        $berkasDasar = BerkasDasar::where('id_user', $usulanPangkat->id_user)->get();
        $user = User::find($usulanPangkat->id_user);
        ...
        return view('pages.kasubag.kenaikanPangkat.proses', compact('usulanPangkat', 'berkasDasar', 'user', 'listPangkat'));
    }
}
