...
class ProsesUsulanKenaikanGajiSekretaris extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.sekretaris.kenaikanGaji.index');
    }
    ...
    public function show(UsulanGaji $usulanGaji)
    {
        ...
        return view('pages.sekretaris.kenaikanGaji.show', compact(['usulanGaji', 'user']));
    }
    ...
    {
        $user = User::find($usulanGaji->id_user);
        return view('pages.sekretaris.kenaikanGaji.edit', compact(['usulanGaji', 'user']));
    }
    ...
    {
        $usulanGaji->status_sekretaris = $request->konfirmasi_berkas;
        $usulanGaji->tanggal_konfirmasi_sekretaris = now();
        if ($request->konfirmasi_berkas == 2) {
            $usulanGaji->alasan_tolak_sekretaris = $request->alasan_ditolak;
    ...
    public function getTimelineUsulanGaji(Request $request)
    {
        ...
        if ($usulanGaji->status_sekretaris != 0 && $usulanGaji->status_kepala_dinas == 0) {
            $btnUbah = '<a href=" ' . route('proses-usulan-kenaikan-gaji-sekretaris.edit', $usulanGaji->id) . '" class="btn btn-sm btn-warning mt-2">Ubah Berkas</a>';
        }
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12">
                                                <div class="single-timeline-content d-flex wow fadeInLeft"
                                                    ...
                                                    <div class="timeline-text">
                                                        ...
                                                        <p>Berkas Masih Diproses</p>
                                                                                                                <div class="row">
                                                        <a href=" ' . route('proses-usulan-kenaikan-gaji-sekretaris.show', $usulanGaji->id) . '" class="btn btn-sm btn-primary mt-2 mr-1 ml-3">Lihat Berkas</a>
                                                        ' . $btnProses . '
                                                        </div>
                                                    </div>
                                                </div>
    ...
    {
        $user = User::find($usulanGaji->id_user);
        return view('pages.sekretaris.kenaikanGaji.proses', compact(['usulanGaji', 'user']));
    }
}
