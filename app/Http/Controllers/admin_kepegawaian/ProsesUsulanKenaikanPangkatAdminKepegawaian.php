...
class ProsesUsulanKenaikanPangkatAdminKepegawaian extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin_kepegawaian.kenaikanPangkat.index');
    }
    ...
    public function show(UsulanPangkat $usulanPangkat)
    {
        ...
        return view('pages.admin_kepegawaian.kenaikanPangkat.show', compact('usulanPangkat', 'berkasDasar', 'user', 'listPangkat'));
    }
    ...
    {
        if (!($usulanPangkat->status_kasubag == 0 && $usulanPangkat->status_kepegawaian != 0 && $usulanPangkat->status_tim_penilai == 1)) {
        ...
        return view('pages.admin_kepegawaian.kenaikanPangkat.edit', compact('usulanPangkat', 'berkasDasar', 'user', 'listPangkat'));
    }
    ...
    {
        $usulanPangkat->status_kepegawaian = $request->konfirmasi_berkas;
        if ($request->has('usulan_pangkat')) {
            $usulanPangkat->pangkat_selanjutnya = $request->usulan_pangkat;
        }
        $usulanPangkat->tmt_pangkat_selanjutnya = date("Y-m-d", strtotime($request->tmt_pangkat_selanjutnya));
        $usulanPangkat->tanggal_konfirmasi_kepegawaian = now();
        if ($request->konfirmasi_berkas == 2) {
            $usulanPangkat->alasan_tolak_kepegawaian = $request->alasan_ditolak;
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12">
                                                <div class="single-timeline-content d-flex wow fadeInLeft"
                                                    ...
                                                    <div class="timeline-text">
                                                        ...
                                                        <p>Berkas Masih Diproses</p>
                                                        <div class="row">
                                                        <a href=" ' . route('proses-usulan-kenaikan-pangkat-admin-kepegawaian.show', $usulanPangkat->id) . '" class="btn btn-sm btn-primary mt-2 ml-3">Lihat Berkas</a>
                                                        ' . $btnProses . '
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12">
                                                <div class="single-timeline-content d-flex wow fadeInLeft"
                                                    ...
                                                    <div class="timeline-text">
                                                        <h6>Admin Kepegawaian</h6>
                                                        <p>Menyetujui Berkas</p>
                                                        <a href=" ' . route('proses-usulan-kenaikan-pangkat-admin-kepegawaian.show', $usulanPangkat->id) . '" class="btn btn-sm btn-primary mt-2">Lihat Berkas</a>
                                                        ' . $btnUbah . '
                                                    </div>
                                                </div>
                                            </div>
    ...
    {
        if (!($usulanPangkat->status_kepegawaian == 0 && $usulanPangkat->status_tim_penilai == 1)) {
            return redirect()->route('proses-usulan-kenaikan-pangkat-admin-kepegawaian.index');
        }
        $berkasDasar = BerkasDasar::where('id_user', $usulanPangkat->id_user)->get();
        $user = User::find($usulanPangkat->id_user);
        ...
        return view('pages.admin_kepegawaian.kenaikanPangkat.proses', compact('usulanPangkat', 'berkasDasar', 'user', 'listPangkat'));
    }
}
