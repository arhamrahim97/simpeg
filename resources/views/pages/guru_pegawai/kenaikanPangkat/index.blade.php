...
<div class="notification">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="text-center mt-2"> <img src="/assets/dashboard/img/illustration/illustration-12.png"
...
<script>
    $(function () {
        var table = $('.yajra-datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('usulan-kenaikan-pangkat.index') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
...
<script>
    ...
    $(document).on('click', '.lihatTimeline', function () {
        ...
        $.ajax({
            type: "POST",
            url: "get-timeline-usulan-kenaikan-pangkat",
            dataType: 'json',
            data: {
                id: id
            },
