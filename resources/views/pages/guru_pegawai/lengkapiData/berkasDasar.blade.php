    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-lg-6 col-12 px-4">
                <form method="POST" id="formBerkas" enctype="multipart/form-data" action="/berkas-dasar">
                    @csrf
                    <div class="border border-grey shadow text-center rounded shadow-sm py-5 px-4"><img
                            src="/assets/dashboard/img/pdf.png" alt="" class="img-fluid" width="100">
                    ...
                    <div class="row gx-4 d-flex justify-content-center">
                        <div class="col-lg-12 mt-3" id="listBerkas">
                            ...
                            <div class="form-group border border-grey shadow-lg rounded p-3"
                                ...
                                <input type="text" class="form-control namaBerkas" id="exampleInputEmail1"
                                    ...
                                    value="{{$deskripsi->deskripsi}}" @if(in_array($deskripsi->deskripsi,
                                $listDeskripsi))
                                readonly @endif>
                                <div class="mb-3 mt-3"><label for="formFileSm" class="form-label">File
                                        Berkas</label><input class="form-control form-control-sm fileBerkas"
                                        id="formFileSm" type="file" name="fileBerkas[]"></div>
                                <div class="div d-flex justify-content-end">
                                    @if(!in_array($deskripsi->deskripsi, $listDeskripsi))
                                    <button href="" class="btn btn-danger btn-sm btnHapusFitur"
                                        id="{{$loop->iteration}}">
                        ...
                        <div class="div">
                            <button type="button" class="btn btn-warning mt-1" id="btnTambahBerkas"> + Tambah
                                Berkas</button>
                        </div>
