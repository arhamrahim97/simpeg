    ...
    <div class="col-xl-7 col-sm-12 mb-5">
        ...
        <div>
            ...
            <select class="form-select form-select-lg mb-3 col-lg-12" aria-label=".form-select-lg example"
                ...
                <option value="1" @if ($usulanGaji->status_kasubag == 1) {{ 'selected' }} @endif>Setuju
                </option>
                <option value="2" @if ($usulanGaji->status_kasubag == 2) {{ 'selected' }} @endif>Tolak
                </option>
            </select>
        </div>

        <div id="form-alasan-ditolak" {{ ($usulanGaji->status_kasubag != 2) ? 'hidden' : '' }}>
            ...
            <textarea class="ckeditor form-control" id="ckeditor" required name="alasan_ditolak"
                readonly>{{$usulanGaji->alasan_tolak_kasubag}}</textarea>
        </div>
        @endif
    </div><!-- End -->
