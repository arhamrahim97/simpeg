...
<div class="row">
    ...
    <div class="col-xl-7 col-sm-12 mb-5">
        <form action="{{route('proses-usulan-kenaikan-pangkat-kasubag.update',$usulanPangkat->id)}}" method="POST"
            id="form-proses">
            @csrf
            @method('PUT')
            <div>
            ...
            <div>
                ...
                <select class="form-select form-select-lg mb-3 col-lg-12" aria-label=".form-select-lg example"
                    ...
                    <option value="1" @if ($usulanPangkat->status_kasubag == 1) {{ 'selected' }} @endif>Setuju
                    </option>
                    <option value="2" @if ($usulanPangkat->status_kasubag == 2) {{ 'selected' }} @endif>Tolak
                    </option>
                </select>
            </div>
            ...
            <div id="form-alasan-ditolak">
                ...
                <textarea class="form-control" id="alasan-ditolak" name="alasan_ditolak"
                    required>{{$usulanPangkat->alasan_tolak_kasubag}}</textarea>
            </div>
