    ...
    <div class="col-xl-7 col-sm-12 mb-5">
        ...
        <div>
            ...
            <select class="form-select form-select-lg mb-3 col-lg-12" aria-label=".form-select-lg example"
                ...
                <option value="1" @if ($usulanPangkat->status_sekretaris == 1) {{ 'selected' }} @endif>Setuju
                </option>
                <option value="2" @if ($usulanPangkat->status_sekretaris == 2) {{ 'selected' }} @endif>Tolak
                </option>
            </select>
        </div>

        <div id="form-alasan-ditolak" {{ ($usulanPangkat->status_sekretaris != 2) ? 'hidden' : '' }}>
            ...
            <textarea class="ckeditor form-control" id="ckeditor" required name="alasan_ditolak"
                readonly>{{$usulanPangkat->alasan_tolak_sekretaris}}</textarea>
        </div>
        @endif
