...
<div class="row">
    ...
    <div class="col-xl-7 col-sm-12 mb-5">
        <form action="{{route('proses-usulan-kenaikan-pangkat-tim-penilai.update',$usulanPangkat->id)}}" method="POST"
            id="form-proses">
            @csrf
            @method('PUT')
            <div>
            ...
            <div id="form-alasan-ditolak">
                ...
                <textarea class="form-control" id="alasan-ditolak" name="alasan_ditolak"
                    required>{{$usulanPangkat->alasan_tolak_tim_penilai}}</textarea>
            </div>
