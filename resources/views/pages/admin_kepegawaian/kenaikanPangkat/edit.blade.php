...
<div class="row">
    ...
    <div class="col-xl-7 col-sm-12 mb-5">
        <form action="{{route('proses-usulan-kenaikan-pangkat-admin-kepegawaian.update',$usulanPangkat->id)}}"
            ...
            <div class="mt-4">
                ...
                <input name="tmt_pangkat_selanjutnya" type="text" class="form-control tanggal"
                    ...
                    value="{{date("d-m-Y", strtotime($usulanPangkat->tmt_pangkat_selanjutnya))}}">
            </div>
            <div>
            ...
            <div id="form-alasan-ditolak">
                ...
                <textarea class="form-control" id="alasan-ditolak" name="alasan_ditolak"
                    required>{{$usulanPangkat->alasan_tolak_kepegawaian}}</textarea>
            </div>
