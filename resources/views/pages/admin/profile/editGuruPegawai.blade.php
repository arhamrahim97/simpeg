        ...
        <div class="col-12 col-md-12 col-lg-6">
            ...
            <div class="form-group @error('pendidikan_terakhir') has-error @enderror">
                ...
                <select class="form-control" name="pendidikan_terakhir">
                    <option value="">- Pilih Salah Satu -</option>
                    <option value="Tidak/Belum Sekolah" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Tidak/Belum Sekolah') selected @endif>Tidak/Belum Sekolah</option>
                    <option value="Tidak Tamat SD/Sederajat" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Tidak Tamat SD/Sederajat') selected @endif>Tidak Tamat SD/Sederajat</option>
                    <option value="Tamat SD/Sederajat" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Tamat SD/Sederajat') selected @endif>Tamat SD/Sederajat</option>
                    <option value="SLTP/Sederajat" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'SLTP/Sederajat') selected @endif>SLTP/Sederajat</option>
                    <option value="SLTA/Sederajat" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'SLTA/Sederajat') selected @endif>SLTA/Sederajat</option>
                    <option value="Diploma I/II" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Diploma I/II') selected @endif>Diploma I/II</option>
                    <option value="Akademi/Diploma III/Sarjana Muda" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Akademi/Diploma III/Sarjana Muda') selected @endif>Akademi/Diploma III/Sarjana Muda</option>
                    <option value="Diploma IV/Strata I" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Diploma IV/Strata I') selected @endif>Diploma IV/Strata I</option>
                    <option value="Strata II" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Strata II') selected @endif>Strata II</option>
                    <option value="Strata III" @if (old('pendidikan_terakhir', $profile->pendidikan_terakhir) == 'Strata III') selected @endif>Strata III
                    </option>
                </select>
            ...
            <div class="form-group d-none @error('jenis_asn') has-error @enderror">
            ...
            <div class="form-group @if($profile->jenis_asn == 'Pegawai') d-none @else @error('jenis_guru') has-error @enderror  @endif" id="form-jenis-guru">
                ...
                <select class="form-control" name="jenis_guru" id="jenis_guru">
                    ...
                    <option value="Guru Mata Pelajaran" @if (old('jenis_guru', $profile->jenis_guru) == 'Guru Mata Pelajaran') selected @endif>Guru Mata Pelajaran</option>
                    <option value="Guru Bimbingan dan Konseling" @if (old('jenis_guru', $profile->jenis_guru) == 'Guru Bimbingan dan Konseling') selected @endif>Guru Bimbingan dan Konseling</option>
                </select>
                @error('jenis_guru')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            ...
            <div class="form-group @error('nuptk') has-error @enderror">
                <label>NUPTK @if($profile->jenis_asn  == 'Pegawai')
        ...
        <div class="col-12 col-md-12 col-lg-6">
            ...
            <div class="form-group @error('status') has-error @enderror">
                ...
                <select class="form-control" name="status">
                    ...
                    <option value="PKKK" @if (old('status', $profile->status) == 'PKKK') selected @endif>PKKK</option>
                    <option value="Honorer" @if (old('status', $profile->status) == 'Honorer') selected @endif>Honorer</option>
                </select>
                @error('status')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
