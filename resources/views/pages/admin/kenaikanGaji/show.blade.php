    ...
    <div class="col-xl-7 col-sm-12 mb-5">
        ...
        <div class="mt-4">
            ...
            <input name="tmt_gaji_selanjutnya" type="text" class="form-control tanggal"
                ...
                value="{{date("d-m-Y", strtotime($usulanGaji->tmt_gaji_selanjutnya))}}" readonly>
        </div>
        ...
        <div id="form-alasan-ditolak" {{ ($usulanGaji->status_kepegawaian != 2) ? 'hidden' : '' }}>
            ...
            <textarea class="ckeditor form-control" id="ckeditor" required name="alasan_ditolak"
                readonly>{{$usulanGaji->alasan_tolak_kepegawaian}}</textarea>
        </div>
        @endif
    </div><!-- End -->
