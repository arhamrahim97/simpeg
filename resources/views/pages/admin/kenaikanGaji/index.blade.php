...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <select class="form-control filterBerkas" id="statusBerkas">
            <option value="">Semua</option>
            <option value="0">Sedang Diperiksa Admin Kepegawaian</option>
            <option value="2">Sedang Diperiksa Kasubag</option>
            <option value="4">Sedang Diperiksa Sekretaris</option>
            <option value="6">Sedang Diperiksa Kepala Dinas</option>
            <option value="1">Ditolak Admin Kepegawaian</option>
            <option value="3">Ditolak Kasubag</option>
            <option value="5">Ditolak Sekretaris</option>
            <option value="7">Ditolak Kepala Dinas</option>
            <option value="8">Selesai Diperiksa</option>
        </select>
    </div>
</div>
...
<script>
    $(function () {
        var table = $('.yajra-datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('proses-usulan-kenaikan-gaji-admin.index') }}",
                data: function (d) {
    ...
    $(document).on('click', '.lihatTimeline', function () {
        ...
        $.ajax({
            type: "POST",
            url: "get-timeline-usulan-kenaikan-gaji-admin",
            dataType: 'json',
            data: {
                id: id
            },
