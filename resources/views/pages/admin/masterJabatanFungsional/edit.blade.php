...
@section('title')
Ubah Master Jabatan Fungsional
@endsection

@section('content')

<form action="{{ route('master-jabatan-fungsional.update',$jabatanFungsional->id) }}" method="POST"
    enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-group @error('gologan') has-error @enderror">
        <label for="errorInput">Gologan</label>
        <input type="text" value="{{ $jabatanFungsional->golongan }}" class="form-control" name="golongan"
    ...
    <div class="form-group @error('jabatan') has-error @enderror">
        ...
        <input type="text" value="{{ $jabatanFungsional->jabatan }}" class="form-control" name="jabatan"
    ...
    <div class="form-group @error('pangkat') has-error @enderror">
        ...
        <input type="text" value="{{ $jabatanFungsional->pangkat }}" class="form-control" name="pangkat"
    ...
    <div class="form-group @error('no_urut') has-error @enderror">
        ...
        <input type="number" value="{{ $jabatanFungsional->no_urut }}" class="form-control" name="no_urut"
