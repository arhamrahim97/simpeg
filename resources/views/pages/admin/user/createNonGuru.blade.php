    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group py-0 @error('tanggal_lahir') has-error @enderror">
                        ...
                        <input name="tanggal_lahir" type="text" class="form-control tanggal" id="tanggal_lahir"
            ...
            <div class="form-group @error('no_hp') has-error @enderror">
                ...
                <input name="no_hp" id="no_hp" type="text" class="form-control" placeholder="Masukkan Nomor HP"
                    value="{{ old('no_hp') }}">
                @error('no_hp')
                <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            ...
            <div class="form-group @error('email') has-error @enderror">
                <label>Email :</label>
                <input name="email" id="email" type="text" class="form-control" placeholder="Masukkan Email"
                    value="{{ old('email') }}">
                @error('email')
                <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            ...
            <div class="form-group @error('nip') has-error @enderror">
                <label>NIP :</label>
                <input name="nip" id="nip" type="text" class="form-control" placeholder="Masukkan NIP"
                    value="{{ old('nip') }}">
                @error('nip')
                <small class="form-text text-danger">{{ $message }}</small>
                @enderror
        ...
        <div class="col-12 col-md-12 col-lg-6">
            <div class="form-group @error('jabatan_pangkat_golongan') has-error @enderror">
                ...
                <select class="form-control select2" name="jabatan_pangkat_golongan" id="jabatan_pangkat_golongan">
                    ...
                    <option value="{{ $row->id }}" selected>{{ $row->jabatan }} - {{ $row->golongan }} -
                        {{ $row->pangkat }}</option>
                    @else
                    <option value="{{ $row->id }}">{{ $row->jabatan }} - {{ $row->golongan }} - {{ $row->pangkat }}
                    </option>
                    @endif
                    @empty
            ...
            <div class="form-group @error('role') has-error @enderror">
                ...
                <select class="form-control" name="role">
                    ...
                    <option value="Admin Kepegawaian" @if (old('role')=='Admin Kepegawaian' ) selected @endif>Admin
                        Kepegawaian</option>
                    <option value="KASUBAG Kepegawaian dan Umum" @if (old('role')=='KASUBAG Kepegawaian dan Umum' )
                        selected @endif>KASUBAG Kepegawaian dan Umum</option>
                    <option value="Sekretaris" @if (old('role')=='Sekretaris' ) selected @endif>Sekretaris</option>
                    <option value="Kepala Dinas" @if (old('role')=='Kepala Dinas' ) selected @endif>Kepala Dinas
                    </option>
                </select>
                @error('role')
                <small class="form-text text-danger">{{ $message }}</small>
            ...
            <div class="form-group @error('username') has-error @enderror">
                ...
                <input name="username" id="username" type="text" class="form-control" placeholder="Masukkan Username"
                    value="{{ old('username') }}">
                @error('username')
                <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            ...
            <div class="form-group @error('password_text') has-error @enderror">
                ...
                <input name="password_text" id="password_text" type="password" class="form-control"
                    placeholder="Masukkan Password" value="{{ old('password_text') }}">
                @error('password_text')
                <small class="form-text text-danger">{{ $message }}</small>
                @enderror
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-8">
                                    <div class="input-file input-file-image">
                                        <img class="img-upload-preview img-circle"
                                            src="{{ old('foto_ttd', '/assets/dashboard/img/blank_photo.png') }}"
                                            alt="preview" width="150" height="150">
                                        <input type="file" class="form-control form-control-file" id="foto_ttd"
                                            name="foto_ttd" accept="image/*" value="{{ old('foto') }}">
                                        <label for="foto_ttd" class="btn btn-primary btn-sm btn-round btn-lg"><i
                                                class="fa fa-file-image"></i> Pilih Gambar</label>
                                        @error('foto_ttd')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                        ...
                        <div class="input-file input-file-image">
                            <div class="row">
                                <div class="col-lg-6 col-md-9 col-sm-8">
                                    <div class="input-file input-file-image">
                                        <img class="img-upload-preview img-circle"
                                            src="{{ old('foto', '/assets/dashboard/img/blank_photo.png') }}"
                                            alt="preview" width="150" height="150">
