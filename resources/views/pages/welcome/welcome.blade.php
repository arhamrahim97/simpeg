...
<section class="pt-4 pt-md-11 mb-7">
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-7 col-lg-8 order-md-1" data-aos="fade-right" data-aos-delay="100">
                <!-- Heading -->
                <div class="mx-auto mx-lg-6">
                    <div class="logo-palu">
                        <img src="{{asset('assets/dashboard/img/kota_palu.png')}}" alt="" class="img-fluid"
                            width="50px">
                    </div>

                    <h1 class="display-3 text-center text-md-start mt-3">
            ...
            <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="200">
                <div class="row">
                    ...
                    <div class="col col-md-12 ms-n5 ms-md-0">
                        ...
                        <!-- Text -->
                        <p class="text-muted mb-6 mb-md-0">
                            Setelah melengkapi Data Diri kemudian lengkapi Berkas Dasar anda, ini dikhususkan untuk yang
                            PNS.
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="col col-md-12 ms-n5 ms-md-0">
                        ...
                        <p class="text-muted mb-0">
                            Usulkan kenaikan gaji / pangkat apabila nama anda telah terdaftar pada usulan Kenaikan Gaji
                            atau Kenaikan Pangkat di bawah ini.
                        </p>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-12 col-md-7" data-aos="fade-right">
                    ...
                    <p class="text-muted mb-4 mb-md-0">
                        Cek nama anda di bawah ini, apakah termasuk ke dalam salah satu usulan kenaikan gaji atau usulan
                        kenaikan pangkat.
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                    <!-- Card -->
                    <div class="card card-border border-primary shadow-light-lg mb-4 mb-md-4 aos-init aos-animate"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="/daftar-usulan-kenaikan-gaji"
                                        class="btn w-100 btn-primary-soft d-flex align-items-center mt-5 lift shadow-sm">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                    <!-- Card -->
                    <div class="card card-border border-success shadow-light-lg mb-4 mb-md-4 aos-init aos-animate"
                        data-aos="fade-up" data-aos-delay="100">
                        <div class="card-body">
                            <!-- Heading -->
                            ...
                            <div class="mt-4">
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="/daftar-usulan-kenaikan-pangkat"
                                        class="btn w-100 btn-success-soft d-flex align-items-center mt-5 lift shadow-sm">
                                        Lihat Selengkapnya <i class="fe fe-arrow-right ms-auto"></i>
                                    </a>
                                    @endif
                                </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 text-center">
                <!-- Heading -->
                <h1 class="fw-bold" data-aos="fade-in" data-aos-delay="100">
        ...
        <div class="row" data-aos="fade-in" data-aos-delay="300">
            <div class="col-12 col-md-4 text-center">
                ...
                <h1 class="display-2 fw-bold text-primary-desat">
                    <span data-countup="{&quot;startVal&quot;: 0}" data-to="{{ $profileAll->count() }}" data-aos=""
                        data-aos-id="countup:in" class="aos-init aos-animate">{{ $profileAll->count() }}</span>
                </h1>
            ...
            <div class="col-12 col-md-4 text-center">
                ...
                <!-- Heading -->
                <h1 class="display-2 fw-bold text-primary-desat">
                    <span data-countup="{&quot;startVal&quot;: 0}" data-to="{{ $profilePNS->count() }}" data-aos=""
                        data-aos-id="countup:in" class="aos-init aos-animate">{{ $profilePNS->count() }}</span>
                </h1>
            ...
            <div class="col-12 col-md-4 text-center">
                ...
                <!-- Heading -->
                <h1 class="display-2 fw-bold text-primary-desat">
                    <span data-countup="{&quot;startVal&quot;: 0}" data-to="{{ $profileNonPNS->count() }}" data-aos=""
                        data-aos-id="countup:in" class="aos-init aos-animate">{{ $profileNonPNS->count() }}</span>
                </h1>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 text-center">
                ...
                <nav class="nav justify-content-center">
                    <a class="badge rounded-pill bg-secondary-soft active me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter="*" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Semua</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".GuruBK" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Guru BK</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".GuruKelas" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Guru Kelas</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".GuruMapel" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Guru Mapel</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".GuruPendamping" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Guru Pendamping</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".GuruPendampingKhusus" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Guru Pendamping Khusus</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".GuruPengganti" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Guru Pengganti</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".GuruTIK" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Guru TIK</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".Instruktur" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Instruktur</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".KepalaSekolah" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Kepala Sekolah</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".Laboran" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Laboran</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".PenjagaSekolah" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Penjaga Sekolah</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".PesuruhOfficeBoy" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Pesuruh/Office Boy</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".PetugasKeamanan" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Petugas Keamanan</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".TenagaAdministrasiSekolah" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Tenaga Administrasi Sekolah</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".TenagaPerpustakaan" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Tenaga Perpustakaan</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".TukangKebun" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Tukang Kebun</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".Tutor" data-bs-target="#fakultas">
                        <span class="h6 text-uppercase">Tutor</span>
                    </a>
                    <a class="badge rounded-pill bg-secondary-soft me-1 mb-1" href="#" data-bs-toggle="pill"
                        data-filter=".Lainnya" data-bs-target="#fakultas">
...
<section class="py-8 pt-md-6 pb-md-0" data-aos="fade-in" data-aos-delay="200">
    <div class="container-fluid">
        <div class="row" id="fakultas" data-isotope="{&quot;layoutMode&quot;: &quot;fitRows&quot;}"
            style="position: relative; height: 5834.25px;">
            <div class="col-12 col-md-6 col-lg-4 justify-content-center GuruBK"
                style="position: absolute; left: 0px; top: 648.25px;">
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center GuruKelas"
                style="position: absolute; left: 0px; top: 648.25px;">
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center GuruMapel"
                style="position: absolute; left: 0px; top: 648.25px;">
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center GuruPendamping"
                style="position: absolute; left: 0px; top: 648.25px;">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-danger-soft">
                                                <span class="h6 text-uppercase">{{ $guruPendampingLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-danger-soft">
                                            <span class="h6 text-uppercase">{{ $guruPendampingPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center GuruPendampingKhusus"
                style="position: absolute; left: 0px; top: 648.25px;">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-info-soft">
                                                <span class="h6 text-uppercase">{{
                                                    $guruPendampingKhususLakilaki->count() }}</span>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-info-soft">
                                            <span class="h6 text-uppercase">{{ $guruPendampingKhususPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-info-soft">
                                                <span class="h6 text-uppercase">{{ $guruPendampingKhususPNS->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-info-soft">
                                            <span class="h6 text-uppercase">{{ $guruPendampingKhususNonPNS->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center GuruPengganti"
                style="position: absolute; left: 0px; top: 648.25px;">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-secondary-soft">
                                                <span class="h6 text-uppercase">{{ $guruPenggantiLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-secondary-soft">
                                            <span class="h6 text-uppercase">{{ $guruPenggantiPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center GuruTIK"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-primary shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center Instruktur"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-success shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-success-soft">
                                                <span class="h6 text-uppercase">{{ $instrukturLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center KepalaSekolah"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-warning shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-warning-soft">
                                                <span class="h6 text-uppercase">{{ $kepalaSekolahLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-warning-soft">
                                            <span class="h6 text-uppercase">{{ $kepalaSekolahPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center Laboran"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-danger shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center PenjagaSekolah"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-info shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-info-soft">
                                                <span class="h6 text-uppercase">{{ $penjagaSekolahLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-info-soft">
                                            <span class="h6 text-uppercase">{{ $penjagaSekolahPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center PesuruhOfficeBoy"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-secondary shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center PetugasKeamanan"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-primary shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-primary-soft">
                                                <span class="h6 text-uppercase">{{ $petugasKeamananLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-primary-soft">
                                            <span class="h6 text-uppercase">{{ $petugasKeamananPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-primary-soft">
                                                <span class="h6 text-uppercase">{{ $petugasKeamananPNS->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center TenagaAdministrasiSekolah"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-success shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-success-soft">
                                                <span class="h6 text-uppercase">{{ $tenagaAdministrasiLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-success-soft">
                                            <span class="h6 text-uppercase">{{ $tenagaAdministrasiPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-success-soft">
                                                <span class="h6 text-uppercase">{{ $tenagaAdministrasiPNS->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-success-soft">
                                            <span class="h6 text-uppercase">{{ $tenagaAdministrasiNonPNS->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center TenagaPerpustakaan"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-warning shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-warning-soft">
                                                <span class="h6 text-uppercase">{{ $tenagaPerpustakaanLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-warning-soft">
                                            <span class="h6 text-uppercase">{{ $tenagaPerpustakaanPerempuan->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-warning-soft">
                                                <span class="h6 text-uppercase">{{ $tenagaPerpustakaanPNS->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        <!-- Badge -->
                                        <span class="badge rounded-pill bg-warning-soft">
                                            <span class="h6 text-uppercase">{{ $tenagaPerpustakaanNonPNS->count()
                                                }}</span>
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center TukangKebun"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-danger shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                            ...
                            <li class="list-group-item px-4 py-3">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end">
                                        ...
                                        <span>
                                            <span class="badge rounded-pill bg-danger-soft">
                                                <span class="h6 text-uppercase">{{ $tukangKebunLakilaki->count()
                                                    }}</span>
                                            </span>
                                        </span>
                                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center Tutor"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-info shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
            ...
            <div class="col-12 col-md-6 col-lg-4 justify-content-center Lainnya"
                style="position: absolute; left: 0px; top: 648.25px;">
                <div class="card card-border border-secondary shadow-lg mb-6 mb-md-8 lift lift-lg ">
                    <div class="card-body p-5">
                        <!-- Icon -->
                ...
                <div class="card shadow-light-lg overflow-hidden" data-aos="fade-up">
                    <div class="row">
                        <div class="col-md-4 position-relative">
                            <!-- Image -->
                            <img src="assets/welcome/img/illustrations/illustration-11.png"
                                class="h-75 position-absolute right-0 mt-7 me-n4" alt="...">
                        </div>
                        <div class="col-md-8">
                            <!-- Body -->
