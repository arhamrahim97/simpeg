...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card shadow-lg">
            <div class="card-header">
                <div class="card-title fw-bold mb-0">Berkas Dasar</div>
            </div>
            <div class="card-body pb-0">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Belum Diproses</p>
                                            <h4 class="card-title">{{$berkasDasarBelumDiproses}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Disetujui</p>
                                            <h4 class="card-title">{{$berkasDasarDisetujui}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Ditolak</p>
                                            <h4 class="card-title">{{$berkasDasarDitolak}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Belum Upload</p>
                                            <h4 class="card-title">{{$berkasDasarBelumUpload}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Guru/Pegawai</p>
    ...
    <div class="col-md-6">
        <div class="card shadow-lg">
            <div class="card-header">
                <div class="card-title fw-bold mb-0">Profil Guru/Pegawai</div>
            </div>
            <div class="card-body pb-0">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Belum Diproses</p>
                                            <h4 class="card-title">{{$profilBelumDiproses}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Disetujui</p>
                                            <h4 class="card-title">{{$profilDisetujui}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Ditolak</p>
                                            <h4 class="card-title">{{$profilDitolak}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Profil Belum Ada</p>
                                            <h4 class="card-title">{{$profilBelumAda}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
